...
sim = ExampleHelperRobotSimulator('simpleMap');% emptyMap, simpleMap, borderMap, complexMap
...
%%
% Define a goal point and a goal radius to stop the robot at the end of the
% path.
goalRadius = 0.1;
