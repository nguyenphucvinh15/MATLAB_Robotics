...
rosinit
sim = ExampleHelperRobotSimulator('borderMap');% emptyMap, simpleMap, borderMap, complexMap
setRobotPose(sim, [4 4 -pi/2]);
...
path = [4 4;4 12;4 20;12 20;20 20;20 12; 20 4;12 4;2 2];
